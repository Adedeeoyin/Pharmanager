...
const Partners_Tools = () => {
  ...
  return (
    <div className='font-euclid w-[70vw] mt-40 mx-auto'>
        <div className=" text-black text-[26px] pt-28 pb-20 font-semibold tracking-tight">Partners manager</div>
                    ...
                    return(
                        <div key={i} className='w-full grid grid-cols-5 gap-2 items-center border border-zinc-400 py-2 pl-6 text-neutral-600 text-sm '>
                            ...
                            <span className='flex items-center gap-8'>
                                <div
                                className={`${item.partner_status == 'Inactive'?'bg-red-700  border-red-700 text-red-700':
                                item.partner_status == 'Active'?'bg-emerald-600 border-emerald-600 text-emerald-600':null}
                                 font-medium bg-opacity-30 border w-20 text-center py-1 rounded-lg`} 
                                >{item.partner_status}</div>
