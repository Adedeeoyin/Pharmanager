...
const Laboratories = () => {
    const results = ['Patholog','Radiology and Medical Imaging','Genetics','Immunology','Blood banks','Fertility testing','Biotechnology specialty']
  ...
  return (
    <div className='mt-40 mx-auto w-[70vw] justify-center flex flex-col'>
        ...
        <h2 className="text-slate-900 pt-8 text-2xl font-medium font-euclid leading-[30px]">Laboratories in Lagos, Nigeria</h2>
