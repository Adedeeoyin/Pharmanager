...
const Hardware = () => {
    const results = ['Wearables technologies','Exoskeleton and mobility aids','Surgical instruments and aids','Patient scanners','Biomedical equipment','Diagnostic aids','Other patient aids']
  ...
  return (
    <div className='mt-40 mx-auto w-[70vw] justify-center flex flex-col'>
        ...
        <h2 className="text-slate-900 pt-8 text-2xl font-medium font-euclid leading-[30px]">Hardware and DeepTech Products in Lagos, Nigeria</h2>
