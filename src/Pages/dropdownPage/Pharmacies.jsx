...
const Pharmacies  = () => {
    const results = ['Physical pharmacies','Digital pharmacies','Consultant pharmacies','Research pharmacies','Managed care pharmacies']
  ...
  return (
    <div className='mt-40 mx-auto w-[70vw] justify-center flex flex-col'>
        ...
        <h2 className="text-slate-900 pt-8 text-2xl font-medium font-euclid leading-[30px]">Pharmacies in Lagos, Nigeria</h2>
